...
- Cash after card debt and a reserve of one month's operating expenses (${o.reserve.latestCompleteExpenseMonth ? label(o.reserve.latestCompleteExpenseMonth) : 'unknown'}: ${bdt(o.reserve.oneMonthOperatingExpenses)}): ${bdt(o.reserve.cashAfterDebtAndReserve)}.`)
